...
class ContentAttributeLinkRepeater extends ContentElement
{
	...
	protected function compile()
	{
		...
		//global $objPage;
		$objAttributeData = $this->Database->prepare("SELECT name, options, use_alternate_source, list_source_table, list_source_field FROM tl_iso_attributes WHERE id=? AND fe_filter='1' AND (type='select' OR type='checkbox')")
									  ->limit(1)
