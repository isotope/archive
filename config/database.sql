...
CREATE TABLE `tl_iso_config` (
  `google_merchant` char(1) NOT NULL default '',
  `google_feedname` varchar(255) NOT NULL default '',
  `google_reader` int(10) unsigned NOT NULL default '0',
  `google_key` varchar(255) NOT NULL default '',
  `google_secret` varchar(255) NOT NULL default '',
  `google_merchant_accountID` varchar(255) NOT NULL default '',
  `google_oauth` blob NULL,
  `google_token` varchar(255) NOT NULL default '',
  `google_token_tstamp` int(10) unsigned NOT NULL default '0',
